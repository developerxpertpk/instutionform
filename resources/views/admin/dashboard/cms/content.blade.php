	...
	<div class="Pages">
		<table class="table table-bordered">
			...
			<?php /*	{{-- Button for edit--}} */ ?>
				...
				<!-- Button for  Delete-->
				<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal_{{$pages->id}}">
					Delete
				</button>

				<!-- Modal  for delete with id=01-->
				<div class="modal fade" id="myModal_{{$pages->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
