...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<div class="row">
			...
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="{{ route('school.index') }}">Home</a></li>
		...
		<div id="school_box">
			...
			<form  name="school_register" class="form-horizontal" role="form" method="post"  enctype="multipart/form-data" action="{{route('school.store')}}">
				{{ csrf_field() }}
				...
				<div class="form-group">
					...
					<div class=" col-sm-6 col-md-6 ">
						<textarea name="school_address" class="form-control" rows="4" required> write here your address </textarea>
					...
					<div class="form-group">
						...
						<div class="col-lg-6 col-md-6">
							<input class="zip form-control " type="text" name="zip" value=""  required onblur="getLocation()"; return false; placeholder="123456">
						</div>
					</div>
				...
				<div class="row col-lg-12 col-md-12">
					...
					<div class="col-md-6 col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-lg-4 col-md-4" id="location">
						...
						<div class="form-group">
							...
							<div class="col-md-4 col-lg-4" id="location">
			...
			<div class="col-md-6 col-lg-6  google-map">
				...
				<div class="form-group">
					<label class="col-sm-6 col-md-4 col-lg-4 control-label"> Images
					</label>
